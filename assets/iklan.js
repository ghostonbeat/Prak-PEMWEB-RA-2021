...
<div class="modal open" id="modal-iklan">
    ...
    <div class="modal-container">
        ...
        <a class="btn btn-yes" href="https://www.dicoding.com/programs/aws/registration/1100554" target="_blank">YES</a>
        <a id="tolak" class="btn btn-no">Don't show this again</a>
...
tolak.addEventListener("click", function(event){
    event.preventDefault();
    let expire = new Date();
    expire.setTime(expire.getTime()+(60*60*24*3*1000)); //Jangan tampilkan iklan selama 3 hari
